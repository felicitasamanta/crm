        ...
        <div class="col-md-12 mt-5">
            <div class="card">
                <div class="card-header">
                    Customers
                    <a class="btn btn-primary float-end" href="customer_new.php">Add new customer</a>
                </div>
                <div class="card-body">
                    <table class="table">
                        <thead>
                        ...
                        <tbody>
                        <?php foreach (Customer::allCustomers() as $customer) { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="contracts.php?id=<?= $customer->getId() ?>">Contracts</a>
                                </td>
                                <td>
